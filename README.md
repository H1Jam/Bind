...
| Rasblery Pi Pico W | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | Pico Bluetooth driver is not perfect yet. Pairing problems and occasionally some crash has been observed (very rare) |
